...
return (
    // containner
        <View style={homeStyles.container}>
          ...
          <Text style={homeStyles.text_isipenjualan}> Isi Penjualan </Text>
          </View>
          ...
          <Text style={homeStyles.text_isipenjualan}> Tidak Ada Penjualan </Text>
          </View>
