...
return (
    // containner
        <View style={homeStyles.container}>
          ...
          < View style={homeStyles.header_atas}>
            <View style={homeStyles.header_atas_fix}>
              ...
              style={homeStyles.gradient_header} >
                ...
                <Text style={homeStyles.text_ordersellout}> Checkin  </Text>
            </LinearGradient>
          ...
          <Text style={homeStyles.text_isipenjualan}> Call Plan </Text>
          </View>
          ...
          <Text style={homeStyles.text_isipenjualan}> Visit </Text>
          </View>
